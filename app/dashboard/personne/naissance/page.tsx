...
const Naissance = () => {
    const columns= [
      ...
      {
          name:"Personne de reference",
          selector:(row)=>row.persref_naissance,
      },
      {
            name:"Action",
            cell:(row)=>(
    ...
    try{
        const req= await fetch("https://cent-kilo.site/api/fetch_all_actenaissance_paginate");
        ...
        <DataTable 
            ...
            subHeaderComponent={
              <div className={styles.head}>
                ...
                <Link href="/dashboard/personne/naissance/add">
