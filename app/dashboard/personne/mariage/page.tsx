...
const Mariage = () => {
    const columns= [
      ...
      {
          name:"Femme",
          selector:(row)=>`${row.noms_pers_femme} ${row.postnom_pers_femme} ${row.prenom_pers_femme}`,
      },
      {
    ...
    try{
        const req= await fetch("https://cent-kilo.site/api/fetch_all_mariage_paginate");
        ...
        <DataTable 
            ...
            subHeaderComponent={
              <div className={styles.head}>
                ...
                <Link href="/dashboard/personne/mariage/add">
